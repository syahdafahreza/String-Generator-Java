 ...
 */
public class StringResult10 extends javax.swing.JFrame {

    /**
     * Creates new form StringResult
     */
    public StringResult10() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        hasilField09 = new javax.swing.JTextField();
        hasilField10 = new javax.swing.JTextField();
        ...
        btnCopy09 = new javax.swing.JButton();
        btnCopy10 = new javax.swing.JButton();
        ...
        hasilField09.setEditable(false);
        hasilField09.setFocusable(false);

        hasilField10.setEditable(false);
        hasilField10.setFocusable(false);
        ...
        btnCopy09.setText("Copy Text");
        btnCopy09.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCopy09ActionPerformed(evt);
            }
        });

        btnCopy10.setText("Copy Text");
        btnCopy10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCopy10ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(hasilField10)
                    .addComponent(hasilField08)
                    .addComponent(hasilField09, javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnCopy09, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnCopy10, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(hasilField09, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnCopy09))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(hasilField10, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnCopy10))
                .addGap(14, 14, 14)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String hasilFieldChk09;
        String hasilFieldChk10;
        ...
        hasilFieldChk09 = hasilField09.getText();
        hasilFieldChk10 = hasilField10.getText();
             ...
             if (hasilFieldChk02!= null)
{
  ...
  btnCopy09.setEnabled(false);
  btnCopy10.setEnabled(false);
}
             break;
             ...
             if (hasilFieldChk09!= null)
{
  ...
  btnCopy10.setEnabled(false);
         ...
         case 9 :
             ...
             hasilField07.setText(RandomString.getAlphaNumericString(n));
             hasilField08.setText(RandomString.getAlphaNumericString(n));
             hasilField09.setText(RandomString.getAlphaNumericString(n));
             
             if (hasilFieldChk10!= null)
{
  // block of code to be executed if the condition is true
  btnCopy10.setEnabled(false);
}
         ...
         case 10 :
             ...
             hasilField08.setText(RandomString.getAlphaNumericString(n));
             hasilField09.setText(RandomString.getAlphaNumericString(n));
             hasilField10.setText(RandomString.getAlphaNumericString(n));
    ...
    private void btnCopy09ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCopy09ActionPerformed
        // TODO add your handling code here:
        String hasilFieldChk09;
        hasilFieldChk09 = hasilField09.getText();
        StringSelection stringSelection = new StringSelection(hasilFieldChk09);
        Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
        clipboard.setContents(stringSelection, null);
    }//GEN-LAST:event_btnCopy09ActionPerformed

    private void btnCopy10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCopy10ActionPerformed
        // TODO add your handling code here:
        String hasilFieldChk10;
        hasilFieldChk10 = hasilField10.getText();
        StringSelection stringSelection = new StringSelection(hasilFieldChk10);
        Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
        clipboard.setContents(stringSelection, null);
    }//GEN-LAST:event_btnCopy10ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StringResult10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btnCopy09;
    private javax.swing.JButton btnCopy10;
    ...
    private javax.swing.JTextField hasilField09;
    private javax.swing.JTextField hasilField10;
