 ...
 */
public class StringResult7 extends javax.swing.JFrame {

    /**
     * Creates new form StringResult
     */
    public StringResult7() {
        initComponents();
    }
  ...
  // block of code to be executed if the condition is true
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StringResult7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
