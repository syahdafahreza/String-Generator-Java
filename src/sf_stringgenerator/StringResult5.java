 ...
 */
public class StringResult5 extends javax.swing.JFrame {

    /**
     * Creates new form StringResult
     */
    public StringResult5() {
        initComponents();
    }
  ...
  // block of code to be executed if the condition is true
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StringResult5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
